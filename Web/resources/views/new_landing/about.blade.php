...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <img src="images/logo.png" width="260px" height="70px" style="margin-left:-50px;">
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
    		<div class="row d-md-flex">
	    		<div class="col-md-6 ftco-animate img about-image" style="background-image: url(images/job_about.jpg);">
	    		</div>
	    		<div class="col-md-6 ftco-animate p-md-5">
		          ...
		          <div class="col-md-12 d-flex align-items-center" style="padding-top:30px;margin-left:15px">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
		              	<div>
			                <!-- <h2 class="mb-4">Offering Reliable Hosting</h2> -->
			              	<p>We at HireConnect believe that job recommendation is a matchmaking process and that a happy work life is attained when both the employees and employers are happy. We aim to help every individual identify the personality traits and knowledge based skills they acquire and recommend them jobs that best suits them. The underlying idea that links your persona with your area of knowledge is that it recommends you to find a job that you love to do. We are a team of thinkers, technologists and doers who aim to bring together different personas who blend together and disrupt markets as a team. </p>
				            </div>
		              </div>
		              ...
		              <div class="tab-pane fade" id="v-pills-mission" role="tabpanel" aria-labelledby="v-pills-mission-tab">
		                <div>
			                <!-- <h2 class="mb-4">Exceptional Web Solutions</h2> -->
			              	<p>To create a happier economic opportunity that uses the best of an individual’s persona. </p>
		              ...
		              <div class="tab-pane fade" id="v-pills-goal" role="tabpanel" aria-labelledby="v-pills-goal-tab">
		                <div>
			                <!-- <h2 class="mb-4">Help Our Customer</h2> -->
			              	<p>To provide the finest recommendations to both employees as well as employers.</p>
