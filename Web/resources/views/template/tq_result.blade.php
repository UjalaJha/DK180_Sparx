            ...
            <div class="card-body">
              ...
              if($level == 1){
                ...
                ?>
                  ...
                  <button style="margin-left:30px;" type="submit" class="btn btn-primary">Start Your Advance Test!!</button>
                </a>
               <?php     
                }else{

                  ?>
                  <h4 style="margin-left:40px;"><b><i>Sorry:-) You coudld not proceed for advance test. </i></b></h4>
              <a href="/next_tq_test">
