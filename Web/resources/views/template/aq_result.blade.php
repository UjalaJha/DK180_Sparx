...
<input type="hidden" value="{{$aq[0]->aq_persistence}}" id="aq_persistence">
          ...
          <input type="hidden" value="{{$aq[0]->aq_curiosity}}" id="aq_queriosity">
<!-- 
          ...
          <h4>Queriosity:{{$aq[0]->aq_queriosity}}</h4> -->
          ...
          <h4>Cueriosity:{{$aq[0]->aq_curiosity}}</h4>
                ...
                <button style="margin-left:30px;" type="submit" class="btn btn-primary">Get Your Complete Result!!</button>
              </a>
                        </div>
                        <!-- ============================================================== -->
