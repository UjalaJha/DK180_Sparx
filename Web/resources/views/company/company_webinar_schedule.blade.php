                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">Your Upcoming Webinars</h4>
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($webinar_details as $webinar)
                                    <tr>
                                       ...
                                       <td>{{$webinar['technology']}}</td>
                                       <td>{{$webinar['time']}}</td>
                                       <td><a href="/take_webinar" class="btn btn-success">Start</a></td>
                                       <td><a href="/end_webinar/{{$webinar['webinar_id']}}" class="btn btn-danger">Close</a></td>
                                    </tr>
                                @endforeach
