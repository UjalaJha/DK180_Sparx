...
<html lang="en">
   <head>
    ...
    <link rel="stylesheet" href="../landingassets/css/bootstrap-select.min.css">
    <link rel="stylesheet" href="../landingassets/fonts/icomoon/style.css">
    <link rel="stylesheet" href="../landingassets/fonts/line-icons/style.css">
...
<div class="site-wrap">
    ...
    <!-- HOME -->
    <section class="home-section section-hero overlay bg-image" style="background-image: url('../landingassets/images/hero_1.jpg');" id="home-section">
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            ...
            <p class="lead text-white">Our Website is all about bringing the best jobs to you.</p>
          </div>
        </div>
    ...
    <section class="site-section">
      <div class="container jobs">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-2">100 Jobs Listed</h2>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="../landingassets/images/logo_mailchimp.svg" alt="Image" class="img-fluid logo-1">
          </div>
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="../landingassets/images/logo_paypal.svg" alt="Image" class="img-fluid logo-2">
          </div>
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="../landingassets/images/logo_stripe.svg" alt="Image" class="img-fluid logo-3">
          </div>
          <div class="col-6 col-lg-3 col-md-6 text-center">
            <img src="../landingassets/images/logo_visa.svg" alt="Image" class="img-fluid logo-4">
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- SCRIPTS -->
    <script src="../landingassets/js/jquery.min.js"></script>
    <script src="../landingassets/js/bootstrap.bundle.min.js"></script>
    <script src="../landingassets/js/isotope.pkgd.min.js"></script>
    <script src="../landingassets/js/stickyfill.min.js"></script>
