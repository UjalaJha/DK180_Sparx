...
<div class="limiter">
    <div class="container-login100" style="background-image: url('../landingassets/static/images/bg-01.jpg');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            ...
            <form method="post" action="/company_login">
                @csrf
                <div class="wrap-input100 validate-input m-b-23" data-validate = "Comapany Email is required">
                    <span class="label-input100">Company Email</span>
                    <input class="input100" type="email" required name="company_email" placeholder="Company Email">
                    <span class="focus-input100" data-symbol="&#xf206;"></span>
                </div>

                <div class="wrap-input100 validate-input" data-validate="Company Password is required">
                    <span class="label-input100">Comapny Password</span>
                    <input class="input100" type="password" required name="company_password" placeholder="Company Password">
                    <span class="focus-input100" data-symbol="&#xf190;"></span>
                </div>
            ...
            <div class="container-login100-form-btn" style="margin-top: 25px;">
                <div class="wrap-login100-form-btn">
                    <div class="login100-form-bgbtn"></div>
                    <a href="/company_signup"><button class="login100-form-btn" type="submit">
                            Sign Up
                        </button></a>
