...
df = pd.read_csv(r"C:/Users/juyee/Envs/sih2020/candidate_recommender/JVR_CandidatesInfo2.csv")
...
def predict_api():
    ...
    path = "C:\\Users\\juyee\\Envs\\sih2020\\candidate_recommender\\Test Profiles\\"+company_role+".csv"
    ...
    profiledata.to_csv("C:\\Users\\juyee\\Envs\\sih2020\\candidate_recommender\\Test Profiles\\profile_data.csv",index=False)
